...
-- We will use a CTE to get the patient encounters and then join with other tables as needed
        ...
        MobileNumbers AS (
         ...
         CPTList as (
					...
					(	
						...
						from
							( 
								select distinct e.PatientDurableKey, b.PrimaryDiagnosisKey, b.DiagnosisComboKey  
		...
		--Select * from PatientEncounters order by LastName
