...
GO
/****** Object:  StoredProcedure [dbo].[sp_PressGaney_MD0104HX_Geriatric_Medicine]    Script Date: 10/21/2025 1:33:54 PM ******/
SET ANSI_NULLS ON
GO
...
------ Survey Type: Geriatric Medicine - Adult Outpatient - MD0104HX 
------
------ PURPOSE:
------ This stored procedure extracts encounter-based patient data for Geriatric Medicine
...
ALTER PROCEDURE [dbo].[sp_PressGaney_MD0104HX_Geriatric_Medicine] 
...
-- We will use a CTE to get the patient encounters and then join with other tables as needed
        ...
        ;WITH PatientEncounters AS (
			--{Encounter Type = (Hospital Encounter) AND Specialty = (Emergency Medicine)} 
					SELECT DISTINCT
					...
					WHERE en.DateKey BETWEEN @StartDateInt AND @EndDateInt
						...
						AND dep.DepartmentSpecialty IN ('Geriatric Medicine')
