...
GO
/****** Object:  StoredProcedure [dbo].[sp_PressGaney_ER0101_EmergencyDept]    Script Date: 10/21/2025 1:33:54 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[sp_PressGaney_ER0101_EmergencyDept] 
...
--Select * from PatientEncounters 
	...
	SELECT DISTINCT
		[Survey Designator] = CASE WHEN inpat.AgeInYears >= 18 THEN 'ER0101' ELSE 'PE0101' END,
